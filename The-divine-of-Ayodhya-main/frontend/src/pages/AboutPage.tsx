...
import { FaFacebook, FaInstagram, FaTwitter, FaYoutube, FaHome, FaImages, 
         FaUserPlus, FaInfoCircle, FaPhone, FaMapMarkerAlt, FaHotel, 
         FaUtensils, FaCar, FaGift, FaLandmark } from 'react-icons/fa';
...
const AboutPage = () => {
  ...
  return (
    <PageLayout>
      <div className="min-h-screen bg-ayodhya-cream">
